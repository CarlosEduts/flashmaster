    ...
    <div className="container py-8 px-4 md:px-6 max-w-3xl">
      ...
      <Card className="mb-8">
        <CardHeader className="pb-2">
          ...
          <CardDescription>
            You've completed your study session for {deck.name}.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="py-6 flex flex-col items-center justify-center">
            ...
            <p className="text-center max-w-md mb-6">
              Your progress has been saved. Keep up the good work and continue
              studying regularly for the best results.
            </p>
