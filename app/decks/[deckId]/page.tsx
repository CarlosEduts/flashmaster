...
import { ArrowLeft, Edit, MoreHorizontal, Plus, Play, Trash2 } from "lucide-react"
    ...
    <div className="container py-8 px-4 md:px-6">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8 gap-4">
        ...
        <div className="flex gap-2 w-full md:w-auto">
          <Button onClick={() => router.push(`/decks/${deckId}/study`)} disabled={cards.length === 0}>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem className="text-destructive focus:text-destructive" onClick={handleDeleteDeck}>
      ...
      <Tabs defaultValue="cards" className="w-full">
        ...
        <TabsContent value="stats">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="text-2xl font-bold">{deck.studyCount || 0}</div>
